...
public partial class GameEntity {
    ...
    public void AddState(Kidvibe.Assets.ECS.Components.Player.State.PlayerStateCore newStateCore) {
        ...
        component.stateCore = newStateCore;
        AddComponent(index, component);
    }

    public void ReplaceState(Kidvibe.Assets.ECS.Components.Player.State.PlayerStateCore newStateCore) {
        var index = GameComponentsLookup.State;
        var component = (Kidvibe.Assets.ECS.Components.Player.State.StateComponent)CreateComponent(index, typeof(Kidvibe.Assets.ECS.Components.Player.State.StateComponent));
        component.stateCore = newStateCore;
