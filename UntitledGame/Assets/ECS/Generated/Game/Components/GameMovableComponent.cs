...
public partial class GameEntity {
    ...
    public void AddMovable(UnityEngine.Rigidbody2D newRigidbody, float newSpeed) {
    ...
    public void ReplaceMovable(UnityEngine.Rigidbody2D newRigidbody, float newSpeed) {
        var index = GameComponentsLookup.Movable;
        var component = (MovableComponent)CreateComponent(index, typeof(MovableComponent));
        component.rigidbody = newRigidbody;
        component.speed = newSpeed;
